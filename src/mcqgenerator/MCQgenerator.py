...
Make sure to format your response like  RESPONSE_JSON below and use it as a guide. Double check if the response is in the correct format! \
Ensure to make {number} MCQs.
Required format of output is given below.
{response_json}
...
Quiz_MCQs:
{quiz}
Generate an analysis for the quiz.
"""
